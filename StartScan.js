// StartScan.js - Version 31.0 - Module de scan unifié Gmail/Outlook
// Correction de la synchronisation avec CategoryManager et des paramètres par défaut

console.log('[StartScan] 🚀 Loading v31.0 - Unified Gmail/Outlook Scanner corrigé...');
...
class UnifiedScanModule {
    constructor() {
        ...
        this.defaultScanOptions = {
            ...
            includeSpam: false,
            autoAnalyze: true,
            autoCategrize: true // Activer par défaut
        };
        ...
        console.log('[StartScan] ✅ Module unifié initialisé v31.0');
    }
    ...
    renderScanInterface(container) {
        ...
        const preselectedCategories = this.getPreselectedCategoriesFromManager();
        console.log('[StartScan] ⭐ Catégories pré-sélectionnées:', preselectedCategories);
            ...
            <div class="scan-interface">
                ...
                ${preselectedCategories.length > 0 ? `
                    <div class="preselected-info">
                        ...
                        <span>Catégories pré-sélectionnées pour les tâches : ${preselectedCategories.join(', ')}</span>
                    </div>
                ` : ''}
                ...
                <div class="scan-options">
                    ...
                    <div class="option-toggles">
                        ...
                        <label class="toggle-option">
                            <input type="checkbox" id="autoCategrize" ${savedOptions.autoCategrize !== false ? 'checked' : ''}>
                            <span class="toggle-slider"></span>
                            <span class="toggle-label">
    ...
    async startScan() {
        ...
        try {
            ...
            const preselectedCategories = this.getPreselectedCategoriesFromManager();
            console.log('[StartScan] ⭐ Catégories pour le scan:', preselectedCategories);
            
            // Lancer le scan avec callback de progression
            const results = await window.emailScanner.scan({
                ...options,
                provider: this.currentProvider,
                taskPreselectedCategories: preselectedCategories, // Passer explicitement
    ...
    // ================================================
    getPreselectedCategoriesFromManager() {
        try {
            if (window.categoryManager?.getTaskPreselectedCategories) {
                ...
                console.log('[StartScan] ⭐ Catégories depuis CategoryManager:', categories);
                return categories;
            }
        } catch (error) {
            console.warn('[StartScan] Erreur récupération catégories:', error);
        }
        
        // Valeurs par défaut si CategoryManager non disponible
        return ['tasks', 'meetings', 'commercial'];
    }
    ...
    resetScan() {
        ...
        document.getElementById('autoCategrize').checked = savedOptions.autoCategrize !== false;
    ...
    addStyles() {
        ...
        styles.textContent = `
            ...
            /* Info des catégories présélectionnées */
            .preselected-info {
                background: #f0f9ff;
...
window.testUnifiedScan = function() {
    console.group('🧪 TEST UnifiedScan v31.0');
    ...
    console.log('Preselected Categories:', window.unifiedScanModule.getPreselectedCategoriesFromManager());
    
    console.groupEnd();
    return { success: true };
};

console.log('✅ StartScan v31.0 loaded - Scanner unifié avec synchronisation CategoryManager!');
