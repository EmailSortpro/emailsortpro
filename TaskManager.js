buildTaskDetailsContent(task) {
        ...
        return `
            <div class="task-details-content-structured">
                ...
                <div class="details-section-content">
                    <div class="task-overview-grid">
                        <div class="overview-item">
                            <div class="overview-label">Titre</div>
                            <div class="overview-value task-title-large">${this.escapeHtml(task.title)}</div>
                        </div>
                        <div class="overview-row">
                            <div class="overview-item">
                                <div class="overview-label">Priorité</div>
                            ...
                            <div class="overview-item">
                                <div class="overview-label">Échéance</div>
                                <div class="overview-value">${dueDateInfo.text || 'Aucune'}</div>
                            </div>
                        </div>
                        <div class="overview-row">
                            <div class="overview-item">
                                <div class="overview-label">Client/Projet</div>
                                <div class="overview-value">${this.escapeHtml(task.client || 'Non défini')}</div>
                            </div>
                            <div class="overview-item">
                                <div class="overview-label">Créé le</div>
                                <div class="overview-value">${new Date(task.createdAt).toLocaleDateString('fr-FR')}</div>
                            </div>
                            <div class="overview-item">
                                <div class="overview-label">Méthode</div>
                                <div class="overview-value">
                                    <span class="method-badge ${task.method === 'ai' ? 'method-ai' : 'method-manual'}">
                                        ${task.method === 'ai' ? '🤖 IA' : '👤 Manuel'}
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                ${task.hasEmail ? `
                    ...
                    <div class="details-section-header">
                        <div class="section-icon">📧</div>
                        <div class="section-title">INFORMATIONS EMAIL</div>
                        <div class="section-line"></div>
                    </div>
                    <div class="details-section-content">
                        <div class="email-info-grid">
                            <div class="email-info-item">
                                <div class="email-info-label">Expéditeur</div>
                                <div class="email-info-value">${this.escapeHtml(task.emailFromName || task.emailFrom || 'Inconnu')}</div>
                            </div>
                            ${task.emailFrom ? `
                                <div class="email-info-item">
                                    <div class="email-info-label">Adresse email</div>
                                    <div class="email-info-value email-address">${this.escapeHtml(task.emailFrom)}</div>
                                </div>
                            ` : ''}
                            ${task.emailSubject ? `
                                <div class="email-info-item">
                                    <div class="email-info-label">Sujet</div>
                                    <div class="email-info-value email-subject">${this.escapeHtml(task.emailSubject)}</div>
                                </div>
                            ` : ''}
                            ${task.emailDate ? `
                                <div class="email-info-item">
                                    <div class="email-info-label">Date de réception</div>
                                    <div class="email-info-value">${new Date(task.emailDate).toLocaleString('fr-FR')}</div>
                                </div>
                            ` : ''}
                            <div class="email-info-item">
                                <div class="email-info-label">Statut réponse</div>
                                <div class="email-info-value">
                                    <span class="reply-status ${task.emailReplied ? 'replied' : 'not-replied'}">
                                        ${task.emailReplied ? '✅ Répondu' : '⏳ En attente'}
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                ${task.description && task.description !== task.title ? `
                    ...
                    <div class="details-section-header">
                        <div class="section-icon">📝</div>
                        <div class="section-title">DESCRIPTION & CONTENU</div>
                        <div class="section-line"></div>
                    </div>
                    <div class="details-section-content">
                        ...
                        <div class="actions-container">
                            ${task.actions.map((action, idx) => `
                                <div class="action-item-detailed">
                                    <div class="action-number-large">${idx + 1}</div>
                                    <div class="action-content">
                                        <div class="action-text-large">${this.escapeHtml(action.text)}</div>
                                        ${action.deadline ? `
                                            <div class="action-deadline-large">
                                                <i class="fas fa-clock"></i>
                                                Échéance: ${this.formatDeadline(action.deadline)}
                                            </div>
                                        ` : ''}
                                    </div>
                                </div>
                    ...
                    <div class="details-section-content">
                        <div class="key-info-container">
                            ${task.keyInfo.map(info => `
                                <div class="key-info-item-detailed">
                                    <div class="key-info-bullet">•</div>
                                    <div class="key-info-text">${this.escapeHtml(info)}</div>
                                </div>
                            `).join('')}
                        </div>
                    </div>
                ...
                ${task.risks && task.risks.length > 0 ? `
                    <!-- ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────════════════════════════════════════════════════════════════════════════════════════════════════════════──────────────────────────────────────── ═══ -->
                    <div class="details-section-header warning">
                        <div class="section-icon">⚠️</div>
                        <div class="section-title">POINTS D'ATTENTION</div>
                        <div class="section-line warning"></div>
                    </div>
                    <div class="details-section-content">
                        <div class="risks-container">
                            ${task.risks.map(risk => `
                                <div class="risk-item-detailed">
                                    <div class="risk-icon">⚠️</div>
                                    <div class="risk-text">${this.escapeHtml(risk)}</div>
                                </div>
                            `).join('')}
                        </div>
                    </div>
                ...
                ${task.suggestedReplies && task.suggestedReplies.length > 0 ? `
                    <!-- ═══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────════════════════════════════════════════════════════════════════════════════════════════──────────────────────────────────────────────── ═══ -->
                    <div class="details-section-header ai">
                        <div class="section-icon">🤖</div>
                        <div class="section-title">SUGGESTIONS DE RÉPONSE IA</div>
                        <div class="section-line ai"></div>
                    </div>
                    <div class="details-section-content">
                        <div class="ai-info-banner">
                            <i class="fas fa-robot"></i>
                            <span>${task.suggestedReplies.length} suggestion${task.suggestedReplies.length > 1 ? 's' : ''} générée${task.suggestedReplies.length > 1 ? 's' : ''} par IA</span>
                            <small>Générées le ${new Date(task.aiRepliesGeneratedAt || task.createdAt).toLocaleString('fr-FR')}</small>
                        </div>
                        <div class="suggestions-container-detailed">
                            ${task.suggestedReplies.map((reply, idx) => `
                                <div class="suggestion-card-detailed">
                                    <div class="suggestion-header">
                                        <div class="suggestion-number">${idx + 1}</div>
                                        <div class="suggestion-tone-info">
                                            <span class="suggestion-tone-badge ${reply.tone}">
                                                ${this.getReplyToneIcon(reply.tone)} ${this.getReplyToneLabel(reply.tone)}
                                            </span>
                                            ${reply.description ? `<span class="suggestion-description">${reply.description}</span>` : ''}
                                        </div>
                                        <div class="suggestion-actions">
                                            <button class="btn-suggestion-copy" onclick="window.tasksView.copyReplyToClipboard(${idx}, '${task.id}')">
                                                <i class="fas fa-copy"></i> Copier
                                            </button>
                                            <button class="btn-suggestion-use" onclick="window.tasksView.useReply('${task.id}', ${idx})">
...
class TaskManager {
    ...
    async loadTasks() {
        try {
            // Utilisation de variable temporaire au lieu de localStorage pour la compatibilité Claude.ai
            const saved = window.tempTaskStorage || null;
            if (saved) {
                this.tasks = saved;
...
`;
    ...
    saveTasks() {
        try {
            // Utilisation de variable temporaire au lieu de localStorage pour la compatibilité Claude.ai
            window.tempTaskStorage = this.tasks;
            console.log(`[TaskManager] Saved ${this.tasks.length} tasks to memory`);
            return true;
        } catch (error) {
...
class TasksView {
    constructor() {
        ...
        this.hideExplanation = window.tempHideExplanation === 'true';
    ...
    hideExplanationMessage() {
        ...
        // Utilisation de variable temporaire au lieu de localStorage
        window.tempHideExplanation = 'true';
        ...
        return `
            <div class="task-details-content">
                ...
                ${task.emailContent && task.emailContent.length > 100 ? `
                    ...
                    <div class="details-section-header">
                        <div class="section-icon">📧</div>
                        <div class="section-title">CONTENU EMAIL ORIGINAL</div>
                        <div class="section-line"></div>
                    </div>
                    <div class="details-section-content">
                        <div class="email-content-section-detailed">
                            ${task.emailHtmlContent ? `
                                <div class="email-content-tabs">
                                    <button class="tab-btn active" onclick="window.tasksView.switchEmailTab('html', '${task.id}')">
                                        <i class="fas fa-eye"></i> Vue formatée
    ...
    addHarmonizedStyles() {
        ...
        styles.textContent = `
            ...
            /* Liste de tâches harmonisée - Vue compacte restaurée */
            ...
            .task-details-content-structured {
                font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;
                line-height: 1.6;
                color: #374151;
                max-width: 100%;
            ...
            /* En-têtes de sections avec séparateurs visuels */
            ...
            .details-section-header:first-child {
                margin-top: 0;
            }
            ...
            /* Variantes colorées pour les sections spéciales */
            .details-section-header.warning .section-icon {
                background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%);
                border-color: #f59e0b;
                color: #92400e;
            }

            .details-section-header.warning .section-title {
            ...
            .details-section-header.warning .section-line {
                background: linear-gradient(90deg, #f59e0b 0%, transparent 100%);
            }

            .details-section-header.ai .section-icon {
                background: linear-gradient(135deg, #e9d5ff 0%, #c4b5fd 100%);
                border-color: #8b5cf6;
                color: #6d28d9;
            }

            .details-section-header.ai .section-title {
                background: linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%);
                -webkit-background-clip: text;
                -webkit-text-fill-color: transparent;
                background-clip: text;
            ...
            .details-section-header.ai .section-line {
            ...
            /* Badges pour priorité, statut, méthode */
            .priority-badge, .status-badge, .method-badge {
                display: inline-flex;
                align-items: center;
                gap: var(--gap-xs);
                padding: 4px 12px;
            ...
            .status-todo { background: #fef3c7; color: #d97706; border: 1px solid #fde68a; }
            .status-in-progress { background: #dbeafe; color: #2563eb; border: 1px solid #bfdbfe; }
            .status-completed { background: #dcfce7; color: #16a34a; border: 1px solid #bbf7d0; }

            .method-ai { background: #e9d5ff; color: #7c3aed; border: 1px solid #c4b5fd; }
            .method-manual { background: #f3f4f6; color: #374151; border: 1px solid #d1d5db; }
            ...
            .ai-info-banner small {
                font-size: 11px;
                opacity: 0.8;
            }

            .suggestions-container-detailed {
                display: flex;
                flex-direction: column;
                gap: var(--gap-lg);
            }

            .suggestion-card-detailed {
                background: #f8fafc;
                border: 1px solid #e2e8f0;
                border-radius: 10px;
                overflow: hidden;
            ...
            .suggestion-tone-badge.formel { background: #f3f4f6; color: #374151; }
            .suggestion-tone-badge.urgent { background: #fef2f2; color: #dc2626; }
            .suggestion-tone-badge.neutre { background: #eff6ff; color: #2563eb; }
            .suggestion-tone-badge.détaillé { background: #f0fdf4; color: #16a34a; }
            ...
            .btn-suggestion-copy, .btn-suggestion-use {
                display: flex;
                align-items: center;
                gap: var(--gap-xs);
                padding: 6px 12px;
            ...
            /* Contenu email */
            .email-content-section-detailed {
                background: #f8fafc;
                border: 1px solid #e2e8f0;
                border-radius: 8px;
                overflow: hidden;
            ...
            /* Cartes de tâches compactes - Vue originale restaurée */
