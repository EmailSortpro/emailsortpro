...
addModernTaskStyles() {
    ...
    styles.textContent = `
        /* CORRECTION: Conteneur principal avec largeur complète */
        .tasks-page-modern {
        ...
        /* CORRECTION: Conteneur des tâches avec marges appropriées */
        ...
        /* Barre principale avec largeur complète */
        .tasks-main-toolbar {
            display: flex;
            align-items: center;
            gap: 12px;
        ...
        /* Section des filtres de statut avec largeur complète */
