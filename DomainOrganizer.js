    ...
    getPageHTML() {
        return `
            ...
            <style>
                ...
                /* Indicateur d'étapes repositionné et corrigé */
                .steps-indicator {
                    display: flex;
                    align-items: center;
                    gap: 12px;
                ...
                /* Liste des domaines avec bon espacement */
                .domains-list {
                    max-height: 400px;
                    overflow-y: auto;
                }
